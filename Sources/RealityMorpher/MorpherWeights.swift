...
///
/// Each component of the ``values`` describes the weighting applied to one of the targets contained in the ``MorpherComponent``. Each element is typically in the range of 0 to 1. A weight of 0 indicates this morph target is ignored, 1 means the model has completely deformed to the target position.
@dynamicMemberLookup public struct MorpherWeights: Animatable, ExpressibleByArrayLiteral {
	...
	/// - Parameter weights: The weights of the targets contained in the ``MorpherComponent``
	...
	/// - Parameter values: The weights of the targets. Each component corresponds to an element of the targets array container in the ``MorpherComponent``.
